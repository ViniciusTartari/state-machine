/**
  Static functions to state machine
*/
#include "sm.h"
...
static void fn_stx(sm_t *sm, unsigned char data){
  /**
    At the beginning of the state machine, everyone is resetting both the received address and the checksum, as it has not yet begun to be verified, as well as the data qtd_rec.
  */
  if(data == STX){
